...
mobile phones per person, \textbf{\textcolor{TealBlue!80!yellow!50}{\Sexpr{Icountry}}} has the highest number of cell subscription density in the world?}
\end{adjustwidth}
\end{minipage}
...
\begin{figure}[H]
\caption*{\textcolor{green!80!yellow!50}{Elegant Charts Inspired by Emelie!}}
...
axTable <- xtable(table_data[c(1,3,4,5)], digits = c(0,0,0,1,1),
       align = "lbc{1.5cm}c{1.5cm}c{2cm}", caption = "\\textcolor{green!80!yellow!50}{Pretty Table inspired by Emelie!}")
...
\tiny{Data Source: \href{http://data.worldbank.org/indicator}{World Bank World Development Indicator}}
\end{minipage}
